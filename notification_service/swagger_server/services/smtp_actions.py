...
# SMTP server details
SMTP_SERVER = os.getenv('SMTP_HOST') #"smtp_dev_server"  # Since smtp4dev runs locally
SMTP_PORT =   os.getenv('SMTP_PORT')# Port configured in Docker
...
'''
curl -X 'POST'   'localhost:8081/notifications/v0/submitnotify'   -H 'accept: */*'   -H 'Content-Type: application/json'   -d '{
  "name": "string",
